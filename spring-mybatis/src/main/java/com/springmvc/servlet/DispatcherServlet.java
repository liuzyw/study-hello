...
public class DispatcherServlet extends HttpServlet {
    ...
    private Map<String, Object> instanceNameMap = new HashMap<String, Object>();
    ...
    private List<Object> buildParamObject(HttpServletRequest req, HttpServletResponse resp, Method method) {
        ...
        for (Parameter parameter : parameters) {
            // 当前参数有别名注解并且别名不为空
            if (parameter.isAnnotationPresent(MyRequestParam.class) && !parameter.getAnnotation(MyRequestParam.class)
                .value().isEmpty()) {
                // 我们获取
                String value = req.getParameter(parameter.getAnnotation(MyRequestParam.class).value());
     ...
     * 组装instanceMap
     */
    private void buildInstanceMap(Set<Class<?>> classes, Map<String, Object> instanceMap,
