...
public class IdcardUtil {
    ...
    public static String convert15To18(String idCard) {
        ...
        if (isNumber(idCard)) {
            ...
            int sYear = DateUtils.getYear(birthDate);
            StringBuilder sb = new StringBuilder();
            idCard18 = sb.append(idCard.substring(0, 6)).append(sYear).append(idCard.substring(8));
            // 获取校验位
    ...
    public static boolean isValidCard(String idCard) {
        ...
        switch (length) {
            ...
            case 10: {// 10位身份证，港澳台地区
                ...
                if (cardval != null && "true".equals(cardval[2])) {
                    return true;
                } else {
                    return false;
                }
    ...
    public static boolean isvalidCard15(String idCard) {
        ...
        if (isNumber(idCard)) {
            ...
            // 生日
            Date birthDate = DateUtils.parse(idCard.substring(6, 12), "yyMMdd");
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(birthDate);
            if (false == DateUtils.isBirthday(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
