 ...
 * @author liuzhaoyuan
 */
public class UpdateIndex implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            doc.add(new TextField("title", "北京大学开学迎来 4380名新生", Store.YES));
            doc.add(new TextField("content", "昨天，北京大学迎来 4380 名 来自全国各地及数十个国家的本科新生。其中，农村学生共 700 余 名，为近年最多.. .·", Store.YES));
